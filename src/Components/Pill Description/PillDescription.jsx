...
function PillDescription () {
  return (
    ...
    <p className='medication-description'>ibuprofen is used for pain management.we recommend for patients to take this medication as a preventative measure. </p>
